...
class CreateAuthTables extends Migration
{
    public function up()
    {
        ...
        // Sellers Table
        $fields = [
            'seller_id' => ['type' => 'int', 'constraint' => 11, 'unsigned' => true, 'auto_increment' => true],
            'user_id'   => ['type' => 'int', 'constraint' => 11, 'unsigned' => true, 'default' => 0],
            'profesi'   => ['type' => 'varchar', 'constraint' => 50, 'null' => true],
            'website'   => ['type' => 'varchar', 'constraint' => 50, 'null' => true],
            'github'    => ['type' => 'varchar', 'constraint' => 50, 'null' => true],
            ...
            'wallet'    => ['type' => 'varchar', 'constraint' => 15, 'null' => true],
            'deskripsi' => ['type' => 'varchar', 'constraint' => 255, 'null' => true],
        ];

        $this->forge->addField($fields);
        $this->forge->addKey('seller_id', true);
        $this->forge->addForeignKey('user_id', 'users', 'id', '', 'CASCADE');
        $this->forge->createTable('tbl_sellers', true);
    }
    ...
    public function down()
    {
        ...
        if ($this->db->DBDriver !== 'SQLite3') { // @phpstan-ignore-line
            ...
            $this->forge->dropForeignKey('tbl_sellers', 'tbl_sellers_user_id_foreign');
        }
        ...
        $this->forge->dropTable('tbl_sellers', true);
    }
}
