        ...
        <div class="card-body">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="/seller/orders/price/" method="post">
                        <?= csrf_field(); ?>
                        ...
                        <div>
                            ...
                            <div class="mb-3">
                                <label for="" class="form-label">Input Price</label>
                                <div class="input-group">
                                    <span class="input-group-text">Rp</span>
                                    <input type="number" class="form-control" name="price" value="<?= $order->harga; ?>" required <?= $order->status_order !== 'process' ? 'disabled' : ''; ?>>
                                </div>
                                <?php if ($order->status_order == 'process') : ?>
                                    <button class="btn btn-primary mt-3" type="submit"><i class="ti ti-check"></i> Save</button>
                                <?php endif; ?>
                            </div>
                        </div>
                    </form>
