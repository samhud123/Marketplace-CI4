            ...
            <div class="col-lg-7">
                <div class="p-5">
                    ...
                    <form action="<?= url_to('register') ?>" method="post" class="user">
                        ...
                        <div class="form-group">
                            <input type="tel" class="form-control form-control-user <?php if (session('errors.no_tlp')) : ?>is-invalid<?php endif ?>" name="no_tlp" placeholder="No. Tlp" value="<?= old('no_tlp') ?>">
                        </div>
                        ...
                        <div class="form-group">
                            <select name="level" id="level" class="form-control <?php if (session('errors.level')) : ?>is-invalid<?php endif ?>">
